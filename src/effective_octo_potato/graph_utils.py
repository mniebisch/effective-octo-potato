...
def _create_lips_edge_index() -> List[Tuple[int, int]]:
    return [
        (61, 146),
        (146, 91),
        (91, 181),
...
@pyg_edge_index_representation
def _create_left_eye_edge_index() -> List[Tuple[int, int]]:
    return [
        (263, 249),
        (249, 390),
        (390, 373),
...
@pyg_edge_index_representation
def _create_left_iris_edge_index() -> List[Tuple[int, int]]:
    return [(474, 475), (475, 476), (476, 477), (477, 474)]


@pyg_edge_index_representation
def _create_left_eyebrow_edge_index() -> List[Tuple[int, int]]:
    return [
        (276, 283),
        (283, 282),
        (282, 295),
...
@pyg_edge_index_representation
def _create_right_eye_edge_index() -> List[Tuple[int, int]]:
    return [
        (33, 7),
        (7, 163),
        (163, 144),
...
@pyg_edge_index_representation
def _create_right_eyebrow_edge_index() -> List[Tuple[int, int]]:
    return [
        (46, 53),
        (53, 52),
        (52, 65),
...
@pyg_edge_index_representation
def _create_right_iris_edge_index() -> List[Tuple[int, int]]:
    return [(469, 470), (470, 471), (471, 472), (472, 469)]


@pyg_edge_index_representation
def _create_face_oval_edge_index() -> List[Tuple[int, int]]:
    return [
        (10, 338),
        (338, 297),
        (297, 332),
...
@pyg_edge_index_representation
def _create_nose_edge_index() -> List[Tuple[int, int]]:
    return [
        (168, 6),
        (6, 197),
        (197, 195),
...
@cat_pyg_edge_index
def _create_face_contours() -> List[torch.Tensor]:
    return [
        _create_lips_edge_index(),
        _create_left_eye_edge_index(),
        _create_left_eyebrow_edge_index(),
        _create_right_eye_edge_index(),
        _create_right_eyebrow_edge_index(),
        _create_face_oval_edge_index(),
    ]


@cat_pyg_edge_index
def _create_irises() -> List[torch.Tensor]:
    return [_create_left_iris_edge_index(), _create_right_iris_edge_index()]


@pyg_edge_index_representation
def _create_face_tesselation() -> List[Tuple[int, int]]:
    return [
        (127, 34),
        (34, 139),
        (139, 127),
...
@cat_pyg_edge_index
def _create_full_face_edge_index() -> List[torch.Tensor]:
    return [
        _create_face_contours(),
        _create_nose_edge_index(),
        _create_irises(),
        _create_face_tesselation(),
    ]
